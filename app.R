...
ui <- fluidPage(theme = shinytheme("superhero"),
                ...
                img(src = "th.jpg", height = 120, width = 330),
                ...
                sidebarLayout(position = "right",
                              ...
                              mainPanel(
                                  ...
                                  br(),
                                  tags$a(href = "https://www.statista.com/", "Source: Covid-19 daily new cases", target = "_blank"),
                                  br(),
                                  tags$a(href = "https://www.kaggle.com/", "Source: Diabetes data", target = "_blank"),
                                  hr(),
...
server <- function(input, output) {
    ...
    output$lineplot <- renderPlot({
        ...
        plot(x = selected_country()$date, y = selected_country()$covid19_cases, type = "l",
             xlab = "Date", ylab = "Covid19 Cases", col = color, fg = color, col.lab = color, col.axis = color)
        if(input$moving){
